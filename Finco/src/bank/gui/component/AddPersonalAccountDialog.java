...
public class AddPersonalAccountDialog extends JDialog {
    ...
    public AddPersonalAccountDialog(PersonalAccountDTO personalAccountDTO)
    {
        super();
        this.account = personalAccountDTO;
    ...
    void JButtonOK_actionPerformed(java.awt.event.ActionEvent event)
    {
        ...
        account.setAccountNo( JTextField_ACNR.getText() );
        account.setCustomerName( JTextField_NAME.getText() );
        account.setEmail(JTextField_EM.getText());
        account.setStreet( JTextField_STR.getText() );
        account.setCity( JTextField_CT.getText() );
        account.setState( JTextField_ST.getText() );
        account.setZip( JTextField_ZIP.getText() );
        account.setBirthDate(JTextField_BD.getText());
