...
public class TransactionDialog extends JDialog {
    ...
    public TransactionDialog(TransactionDTO transactionDTO) {
        super();
        ...
        //}}
        JTextField_NAME.setText(transactionDTO.getAccountNumber());
    ...
    void JButtonOK_actionPerformed(java.awt.event.ActionEvent event) {
        transactionDTO.setAmount(Double.parseDouble(JTextField_Deposit.getText()));
        dispose();
    }
