...
public class AddAccountDialog extends JDialog {
    ...
    public AddAccountDialog(Account account)
    {
        super();
    ...
    void JButtonOK_actionPerformed(java.awt.event.ActionEvent event)
    {
        ...
        ACustomer customer = (ACustomer)account.getCustomer();
        customer.setName(JTextField_NAME.getText());
        customer.setStreet(JTextField_STR.getText());
        customer.setCity(JTextField_CT.getText());
        customer.setState(JTextField_ST.getText());
        customer.setZip(JTextField_ZIP.getText());
