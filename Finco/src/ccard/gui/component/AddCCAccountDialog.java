 ...
 */
public class AddCCAccountDialog extends JDialog {


    private AccountDTO account;

    public AddCCAccountDialog(AccountDTO account)
    {
        super();
    ...
    void JButtonOK_actionPerformed(java.awt.event.ActionEvent event)
    {
        ...
        account.setAccountNo( JTextField_CCNR.getText() );
        ...
        account.setExpDate(JTextField_ExpDate.getText());
